...
public class DolgozatNaptarView : IEvolView
{
    ...
    public Control CreateView()
    {
        ...
        _monthYearTextBlock = new TextBlock { VerticalAlignment = VerticalAlignment.Center, FontWeight = FontWeight.Bold, FontSize=16 };
    ...
    private void PopulateCalendar()
    {
        ...
        for (int i = 0; i < 7; i++) _calendarGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Star });
        _calendarGrid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto });
        for (int i = 0; i < 6; i++) _calendarGrid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Star });
        ...
        int dayOfWeek = ((int)firstDayOfMonth.DayOfWeek + 6) % 7; // 0=Monday
        ...
        for (int i = 0; i < daysInMonth; i++)
        {
            ...
            if (testsForDay != null && testsForDay.Any())
            {
                ...
                var indicator = new Border { Background = Brushes.Red, CornerRadius = new CornerRadius(3), Width = 6, Height=6, HorizontalAlignment = HorizontalAlignment.Right, VerticalAlignment=VerticalAlignment.Top, Margin=new Thickness(2) };
    ...
    private void Day_PointerPressed(object? sender, Avalonia.Input.PointerPressedEventArgs e)
    {
